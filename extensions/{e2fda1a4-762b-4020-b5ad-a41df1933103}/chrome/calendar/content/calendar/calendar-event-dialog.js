...
function showGeoLocation() {
	...
	if( getElementValue("Location-lat") == 0 && getElementValue("Location-lgt") == 0 )
	{
		geolocation.getCurrentPosition(function(position)
		{
			...
			document.getElementById("iFrameGeo").hidden = false;
			window.iFrameGeo.initGMap(position.coords.latitude, position.coords.longitude);
		});
	}
	else
	{
		document.getElementById("iFrameGeo").hidden = false;
		window.iFrameGeo.initGMap(getElementValue("Location-lat"), getElementValue("Location-lgt"));
	}
